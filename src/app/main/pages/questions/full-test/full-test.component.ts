...
import { formatTimer, generatePDF } from 'src/app/shared/material/utils/utils';
import { TrueOrFalse } from 'src/app/shared/models/true-or-false.model';
import { beerCharacteristicsEN } from 'src/app/shared/questions/english-beer-characteristic';
import { S0, S0TITLE } from 'src/app/shared/questions/english-questionsMock';
import { beerCharacteristicsPT } from 'src/app/shared/questions/portuguese-beer-characteristic';
import { S0PT, S0TITLEPT } from 'src/app/shared/questions/portuguese-questionsMock';
import { ENGLISH_QUESTIONS, PORTUGUESE_QUESTIONS } from 'src/app/shared/questions/questions-array';
import { ENGLISHQUESTIONS, PORTUGUESEQUESTIONS } from 'src/app/shared/questions/questions-per-language';
import { trueOrFalseMockEN, trueOrFalseMockPT } from 'src/app/shared/questions/true-or-false';
